...
AK_FINE_PROGRESS_LEN	equ 41350
AK_SMP_LEN				equ 41350
...
.NoClampLPF_5_8
				...
				sub.l	d6,d5
				cmp.l	#32767,d5
				ble.s	.NoClampMaxHPF_5_8
				move.w	#32767,d5
				bra.s	.NoClampMinHPF_5_8
.NoClampMaxHPF_5_8
				cmp.l	#-32768,d5
				bge.s	.NoClampMinHPF_5_8
				move.w	#-32768,d5
.NoClampMinHPF_5_8
...
AK_Vars:
				...
				dc.l	$0000209e		; Instrument 4 Length 
				dc.l	$000003e8		; Instrument 5 Length 
