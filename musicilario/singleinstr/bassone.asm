...
.NoClampLPF_1_12
				...
				sub.l	d6,d5
				cmp.l	#32767,d5
				ble.s	.NoClampMaxHPF_1_12
				move.w	#32767,d5
				bra.s	.NoClampMinHPF_1_12
.NoClampMaxHPF_1_12
				cmp.l	#-32768,d5
				bge.s	.NoClampMinHPF_1_12
				move.w	#-32768,d5
.NoClampMinHPF_1_12
...
AK_Vars:
				dc.l	$00001770		; Instrument 1 Length 
